...
$myfile = fopen("sarfile.txt", "w") or die("Unable to open file!");
fwrite($myfile, $str);
fclose($myfile);
...
if ($conn->connect_error) {
  ...
  // $str = $str +  "Connected successfully"; 
}
    
    

$sql = "SELECT Name, Category,linedescription, WebLink, Rating, owner, Broker, Verified, ND, Photos, USP, Negatives, AL FROM Kristy WHERE Category='Listings';";
        ...
        if($colcount == 4)
         ...
         echo "<div class='col-md-4'>
                <div class='card' data-toggle='collapse' data-target='#cardcollapse1".$x."'>
                        <div class='ratinglabel five'>5&nbsp;<i class='fa fa-star' aria-hidden='true'></i></div><img class='card-img-top cardlogo' src='(".$x.").png' alt='Card image cap'>
